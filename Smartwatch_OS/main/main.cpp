...
#define I2C_MASTER_FREQ_HZ 100000 // 100kHz is the safest speed for shared sensor buses
...
// Manually clear and prepare the I2C bus pins to avoid INVALID_STATE on boot
void i2c_clear_bus() {
...
int pmu_register_read(uint8_t devAddr, uint8_t regAddr, uint8_t *data, uint8_t len) {
    ...
    // Timeout 1000 ensures we wait without returning early errors
...
extern "C" void app_main(void) {
    ...
    // 3. Connect to the shared I2C bus and init PMU
    if (i2c_init() == ESP_OK) {
